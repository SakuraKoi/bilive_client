...
class Online extends AppClient {
    ...
    public get biliUID(): number {
        return this.userData.biliUID
    }

    public set biliUID(biliUID: number) {
        this.userData.biliUID = biliUID
    }
    ...
    public set cookieString(cookieString: string) {
        this.userData.cookie = cookieString
    }
